...
namespace Hybriotheca.Web.Migrations
{
    ...
    [Migration("20231018120907_ChangeLocationAndContactOfLibrary")]
    partial class ChangeLocationAndContactOfLibrary
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hybriotheca.Web.Data.Entities.Rating", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserID", "BookEditionID" }, "IX_AppUser_BookEdition")
                        .IsUnique();
            ...
            modelBuilder.Entity("Hybriotheca.Web.Data.Entities.Subscription", b =>
                {
                    ...
                    b.ToTable("Subscriptions", t =>
                        {
                            t.HasCheckConstraint("CK_MaxLoanDays_GreaterOrEqualZero", "[MaxLoanDays] >= 0");

                            t.HasCheckConstraint("CK_MaxLoans_GreaterOrEqualZero", "[MaxLoans] >= 0");
                        });
                });
